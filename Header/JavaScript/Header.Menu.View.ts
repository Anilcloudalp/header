...
export = BackboneView.extend({
    ...
    getContext: function() {
        ...
        const config  = SC.CONFIGURATION.layout.colorPalette;
      ...
      colors =  config.map(color => {
            // console.log(color.colorName, " , ", color.colorValue)
        ...
        const show_currencies =
            ...
            const underground = _.map(Configuration.get('home.header', []), function(
                url: string
            ) 
            {
